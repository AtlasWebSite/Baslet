        ...
        {chartPoints.map((point, index) => {
          ...
          return (
            <g key={`${point.date}-${index}`} className={`admin-barchart__datum ${active ? 'is-active' : ''}`} onMouseEnter={() => setHoveredIndex(index)}>
              ...
              {point.value > 0 && <rect className="admin-barchart__bar" x={x} y={y} width={barWidth} height={barHeight} rx="0" ry="0" />}
        ...
        {hoveredIndex !== null && (() => {
          ...
          return (
            <g className="admin-barchart__tooltip" pointerEvents="none">
              <rect x={tooltipX} y={tooltipY} width={tooltipWidth} height={tooltipHeight} rx="0" />
...
const donutPalette = ['#ffffff', '#737373', '#d4d4d4', '#a3a3a3', '#404040'];

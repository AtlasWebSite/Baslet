...
export function MindMapCanvas({ nodes, edges, mode, expandedTermIds, selectedNode, saving, saved, onNodesChange, onModeChange, onToggleTerm, onExpandAll, onCollapseAll, onSelectNode, onRegenerate, onSave }: MindMapCanvasProps) {
